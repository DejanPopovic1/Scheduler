...
namespace SchedulerTest
{
    public class Tests
    {
        ...
        public void Setup()
        {
            ...
            //schedule2.AddEdges(new List<Vertex<TimeSpan[]>>() { schedule3 });
            //schedule3.AddEdges(new List<Vertex<TimeSpan[]>>() { schedule2, schedule4, schedule5 });
            //schedule4.AddEdges(new List<Vertex<TimeSpan[]>>() { schedule3, schedule5, schedule6 });
            //schedule5.AddEdges(new List<Vertex<TimeSpan[]>>() { schedule3, schedule4, schedule6 });
            //schedule6.AddEdges(new List<Vertex<TimeSpan[]>>() { schedule4, schedule5, schedule7 });
            //schedule7.AddEdges(new List<Vertex<TimeSpan[]>>() { schedule6 });
        }
